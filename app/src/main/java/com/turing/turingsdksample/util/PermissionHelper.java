...
import com.turing.turingsdksample.activity.MainFragmentActivity;
...
public class PermissionHelper {
    ...
    public void openAppDetails() {
        ...
        builder.setMessage("需要访问权限，请到 “应用信息 -> 权限” 中授予！");
    ...
    public PermissionHelper(@NonNull Activity activity, @NonNull MainFragmentActivity permissionInterface) {
        mActivity = activity;
